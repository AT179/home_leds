...
const char* mqttUsername = "computer_desk_mqtt";
const char* mqttPassword = "compdeskmqtt";
...
#define SENSORNAME "dnd_under_table"
...
// FastLED Definitions
#define NUM_LEDS 243    // TODO: numleds changes from deivce to device
#define DATA_PIN 5
...
void sendState() {
  ...
  // client.publish(lightStateTopic, buffer, true);
